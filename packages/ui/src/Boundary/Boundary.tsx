...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    ...
    return <EmptyState size={this.props.size} view={{ kind: 'error', message: isDevelopment ? err.message : '문제가 생겼습니다', retry: this.reset }} error={{ title: '문제가 생겼습니다', body: '화면을 다시 불러오면 대부분 해결됩니다. 반복되면 알려주세요.', action: { label: '다시 불러오기', onClick: this.reset } }}>{() => null}</EmptyState>;
  }
}
